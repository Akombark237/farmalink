...
export default function AdminDashboard() {
  ...
  const recentOrders = [
    { id: '#ORD-001', patient: 'John Doe', pharmacy: 'MedPlus Pharmacy', amount: 45.99, status: 'completed', time: '2 hours ago' },
    { id: '#ORD-002', patient: 'Sarah Wilson', pharmacy: 'HealthCare Central', amount: 89.50, status: 'processing', time: '4 hours ago' },
    { id: '#ORD-003', patient: 'Mike Johnson', pharmacy: 'City Pharmacy', amount: 23.75, status: 'pending', time: '6 hours ago' }
  ];
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {['MedPlus Pharmacy', 'HealthCare Central', 'City Pharmacy', 'Quick Meds'].map((pharmacy, index) => (
                      <div key={pharmacy} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                        <div className="flex items-center space-x-3">
                        ...
                        <div className="text-right">
                          <p className="text-sm font-medium text-gray-900">${(Math.random() * 5000 + 1000).toFixed(0)}</p>
