...
const nextConfig = {
      ...
      return [
        {
          ...
          destination: 'https://pharmalink.vercel.app/:path*',
          permanent: true,
        },
      ];
    }
  ...
  typescript: {
    ignoreBuildErrors: false, // Enable for security
  },
  eslint: {
    ignoreDuringBuilds: false, // Enable for security
  },
  images: {
    domains: ['localhost', 'pharmalink.vercel.app'],
